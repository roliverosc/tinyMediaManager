  ...
  public void actionPerformed(ActionEvent e) {
    ...
    for (Object obj : selectedObjects) {
      ...
      if (obj instanceof TvShowSeason) {
        ...
        ImageChooserDialog dialog = new ImageChooserDialog(MainWindow.getFrame(), ids, ImageType.SEASON,
            TvShowList.getInstance().getAvailableArtworkScrapers(), imageLabel,

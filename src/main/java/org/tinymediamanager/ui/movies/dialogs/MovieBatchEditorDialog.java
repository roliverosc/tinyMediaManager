  ...
  public MovieBatchEditorDialog(final List<Movie> movies) {
...

    {
      ...
      panelContent.setLayout(new FormLayout(
          new ColumnSpec[] { FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("right:default"), FormSpecs.DEFAULT_COLSPEC,
              ColumnSpec.decode("200dlu:grow"), FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC,
      ...
      panelContent.add(btnLanguage, "6, 16");
      {
        ...
        panelContent.add(btnSetSorttitle, "4, 18");
        ...
        panelContent.add(btnClearSorttitle, "4, 20");
      }
    }
